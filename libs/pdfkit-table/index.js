/** Archiyou: Added custom pdfkit-table module to avoid some problems 
 *     This is pdfkit-table version 0.1.99
 *      
 * 
*/
// jshint esversion: 6
...
export default function makePDFDocumentWithTables(PDFDocument) // PDFDocument
{
    ...
    console.info('**** PDFKIT-TABLE: Added pdfkit-table! ****')
