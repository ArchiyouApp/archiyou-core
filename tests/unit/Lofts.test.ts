...
{
    let c = brep.Circle();
    let r = brep.Rect().move(0,0,100);
    let v = brep.Vertex(200,0,300);
...
test("LoftOpen", () => 
{
    let l1 = brep.Polyline([0,0],[100,0],[100,100]).move(0,200);
    let a = brep.Arc([0,0],[0,50],[50,50]).move(0,200,300);
    let v2 = brep.Vertex(0,150,500)
