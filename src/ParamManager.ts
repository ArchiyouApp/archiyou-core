...
import { ParamType, Param } from './internal'
...
{   
    ...
    */
    ...
    {
        this.target._behaviour = (curParam:Param, params?:Array<Param>) => {
                                    const r = test(curParam,params); 
                                    this.target.visible = (typeof r !== 'boolean') ? false: r;
        }
    }
    ...
    /** Set start value of range on number Param */
...
export class ParamManager
{
    ...
    constructor(params?:Array<Param>)
    {
        ...
        {
            this.paramControllers = params.map(p => new ParamManagerEntryController(p))
